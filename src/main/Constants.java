...
public class Constants {
    ...
    // public static final int framesBeforeReset = 180;
    ...
    public static final double addConnectionChance = 2.0; // chance to add a connection between two random existing nodes
